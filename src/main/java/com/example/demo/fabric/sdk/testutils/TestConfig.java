 ...
 */
package com.example.demo.fabric.sdk.testutils;
...
//                    DEFAULT_CONFIG));
            ...
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.ca_location", "http://104.155.167.164:7054");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.peer_locations", "peer0.org1.example.com@grpc://104.155.167.164:7051, peer1.org1.example.com@grpc://104.155.167.164:7056");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.orderer_locations", "orderer.example.com@grpc://104.155.167.164:7050");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.eventhub_locations", "peer0.org1.example.com@grpc://104.155.167.164:7053,peer1.org1.example.com@grpc://104.155.167.164:7058");
            ...
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.ca_location", "http://104.155.167.164:8054");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.peer_locations", "peer0.org2.example.com@grpc://104.155.167.164:8051,peer1.org2.example.com@grpc://104.155.167.164:8056");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.orderer_locations", "orderer.example.com@grpc://104.155.167.164:7050");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.eventhub_locations", "peer0.org2.example.com@grpc://104.155.167.164:8053, peer1.org2.example.com@grpc://104.155.167.164:8058");
            ...
            for (Map.Entry<String, SampleOrg> org : sampleOrgs.entrySet()) {
                ...
                if (runningFabricCATLS) {
                    String cert = "src/main/java/com/example/demo/fabric/fixture/sdkintegration/e2e-2Orgs/channel/crypto-config/peerOrganizations/DNAME/ca/ca.DNAME-cert.pem".replaceAll("DNAME", domainName);
    ...
    private final static String tlsbase = "src/main/java/com/example/demo/fabric/fixture/sdkintegration/e2e-2Orgs/tls/";
    ...
    public String getTestChannlePath() {
        ...
        return "src/main/java/com/example/demo/fabric/fixture/sdkintegration/e2e-2Orgs/channel";
