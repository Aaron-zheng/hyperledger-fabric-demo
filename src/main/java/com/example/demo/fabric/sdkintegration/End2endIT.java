...
package com.example.demo.fabric.sdkintegration;

import com.example.demo.fabric.sdk.testutils.TestConfig;
import com.example.demo.fabric.sdk.testutils.TestConfigHelper;
...
public class End2endIT {
    ...
    private static final String TEST_FIXTURES_PATH = "src/main/java/com/example/demo/fabric/fixture";
